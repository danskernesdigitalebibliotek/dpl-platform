...
try {
  ...
  throw Error("An error occured while making the database backup, the program will end now", {
    cause: error,
  })
}
...
try {
  ...
  throw Error("Failed to copy the backup from lagoon-core-api-db-0 to local machine", {
    cause: error,
  })
}
