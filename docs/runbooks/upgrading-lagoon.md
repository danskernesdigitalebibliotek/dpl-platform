...
- Knowledge of any breaking changes or necessary actions that may affect the
  platform when upgrading. See chart release notes for _all_ intermediate chart
  releases.
...
2. Upgrade Lagoon remote
   ...
   4. Take note in the output from Helm of any CRD updates that _may_ be required
